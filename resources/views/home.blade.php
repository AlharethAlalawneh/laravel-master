    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 d-flex">
    				<div class="img d-flex align-self-stretch" style="background-image:url(myimg/2.jpg);"></div>
    			</div>
        ...
        <div class="row">
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="archaeological" class="img" style="background-image: url(myimg/3.jpg);">
        				<div class="text">
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="medical" class="img" style="background-image: url(myimg/4.jpg);">
        				<div class="text">
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="enjoyment" class="img" style="background-image: url(myimg/5.jpg);">
        				<div class="text">
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="religious" class="img" style="background-image: url(myimg/6.jpg);">
        				<div class="text">
        ...
        <div class="row">
        	<div class="col-md-4 ftco-animate">
        		<div class="project-wrap">
        			<a href="petradetails" class="img" style="background-image: url(myimg/7.jpg);"></a>
        			<div class="text p-4">
        	...
        	<div class="col-md-4 ftco-animate">
        		<div class="project-wrap">
        			<a href="wadidetails" class="img" style="background-image: url(myimg/8.jpg);"></a>
        			<div class="text p-4">
        				<span class="price">10JOD/person</span>
        				<span class="days">1 Day Tour</span>
        	...
        	<div class="col-md-4 ftco-animate">
        		<div class="project-wrap">
        			<a href="aqabadetails" class="img" style="background-image: url(myimg/9.webp);"></a>
        			<div class="text p-4">
        	...
        	<div class="col-md-4 ftco-animate">
        		<div class="project-wrap">
        			<a href="ammandetails" class="img" style="background-image: url(myimg/10.jpg);"></a>
        			<div class="text p-4">
        	...
        	<div class="col-md-4 ftco-animate">
        		<div class="project-wrap">
        			<a href="alqiamadet" class="img" style="background-image: url(myimg/11.jpg);"></a>
        			<div class="text p-4">
        	...
        	<div class="col-md-4 ftco-animate">
        		<div class="project-wrap">
        			<a href="deaddetails" class="img" style="background-image: url(myimg/12.jpg);"></a>
        			<div class="text p-4">
