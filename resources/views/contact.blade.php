...
@section('page')
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('myimg/31.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row d-flex contact-info">
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p>Aqaba Jordan ,street said-darwesh 234</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://1234567920">+03 201 3467</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="JwanTravel@email.com">JwanTravel@email.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
